...
## Components
- Buttons: pill, Hanken 600, 44px min hit area. Primary = ink text on celadon. Secondary = white fill / ink hairline. Focus = 2px celadon ring, 2px offset.
- Toolbar: `--wash` pill, hairline border, tools 44×44, active tool = ink fill / paper icon.
- Panels (book, frame bar, element dock): white, `--wash` header, hairline.
